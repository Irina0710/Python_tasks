...
# List Comprehension - быстрое создание списка
# Создаем список четных элтов от 1 до 100 обычным способом
...
# print(List)
# тоже самое можем записать проще
List = [i for i in range(1, 21) if i%2 == 0]
print(List)
# также  можем задать кортежи 
List = [(i, i) for i in range(1, 21) if i%2 == 0]
print(List)
# также  можем при задаче кортежей использовать функции
def f(x):
    return x**3
